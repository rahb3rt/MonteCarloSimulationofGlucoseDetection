...
double verdet[3]={0.3,0,0};        // angle of Faraday rotation per one lsa, = VB/2 cdot displacement, the factor 2 comes from right and left-circular polarization rotates by +-angle respectively.
const int photons=100*10*10;
...
int main ()
{
	...
	//Print to file
	ofstream fp_out;
	fp_out.open("linearoutput_verdet.csv",ios::out); 
	...
	int N= 38; 76; //The number of thetaB angles measured
	int N2= 35; 73; //The number of phiB angles measured
