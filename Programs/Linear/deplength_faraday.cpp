...
double verdet[3]={0,0,0.1};        // angle of Faraday rotation per one lsa, = VB/2 cdot displacement, the factor 2 comes from right and left-circular polarization rotates by +-angle respectively.
...
int main ()
{
	...
	//Print to file
	ofstream fp_out;
	fp_out.open("linearoutput_circularz.csv",ios::out); 
